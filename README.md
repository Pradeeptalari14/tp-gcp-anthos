# 🕸️ GCP Anthos Service Mesh Studio
...
[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/gcp-anthos/)
...
```bash
kubectl port-forward deployment/tp-gcp-anthos 8080:8080
```
...
```bash
kubectl run load-generator --image=busybox --restart=Never -- /bin/sh -c "while true; do wget -q -O- http://tp-gcp-anthos; done"
```
...
# Primary Config File: asm_policy.yaml
```
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/gcp-anthos/) |
